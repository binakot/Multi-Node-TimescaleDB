...
SELECT add_data_node('data_node_3', host => 'pg_data_node_3');

SELECT create_distributed_hypertable('telemetries', 'time', 'imei', chunk_time_interval => INTERVAL '1 week', replication_factor => 2);
